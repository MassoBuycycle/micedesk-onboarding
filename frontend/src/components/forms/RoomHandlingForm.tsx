...
const operationalSchema = z.object({
  revenue_manager_name: z.string().nullable().optional().or(z.literal('')),
  revenue_contact_details: z.string().nullable().optional().or(z.literal('')),
  demand_calendar: z.boolean().default(false),
  demand_calendar_infos: z.string().nullable().optional().or(z.literal('')),
  revenue_call: z.boolean().default(false),
  revenue_calls_infos: z.string().nullable().optional().or(z.literal('')),
  group_request_min_rooms: z.coerce.number().optional(),
  group_reservation_category: z.string().nullable().optional().or(z.literal('')),
  group_rates_check: z.boolean().default(false),
  group_rates: z.string().nullable().optional().or(z.literal('')),
  group_handling_notes: z.string().nullable().optional().or(z.literal('')),
  ...
  first_option_hold_duration: z.string().nullable().optional().or(z.literal('')),
  overbooking: z.boolean().default(false),
  overbooking_info: z.string().nullable().optional().or(z.literal('')),
  min_stay_weekends: z.boolean().default(false),
  min_stay_weekends_infos: z.string().nullable().optional().or(z.literal('')),
  call_off_quota: z.boolean().default(false),
  call_off_method: z.string().nullable().optional().or(z.literal('')),
  call_off_deadlines: z.string().nullable().optional().or(z.literal('')),
  call_off_notes: z.string().nullable().optional().or(z.literal('')),
  commission_rules: z.string().nullable().optional().or(z.literal('')),
  free_spot_policy_leisure_groups: z.string().nullable().optional().or(z.literal('')),
  restricted_dates: z.string().nullable().optional().or(z.literal('')),
  handled_by_mice_desk: z.boolean().default(false),
  mice_desk_handling_scope: z.string().nullable().optional().or(z.literal('')),
  ...
  final_invoice_handling: z.string().nullable().optional().or(z.literal('')),
  deposit_invoice_responsible: z.string().nullable().optional().or(z.literal('')),
