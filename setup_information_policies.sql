-- Setup script for Information Policies
-- Run this script to set up the information policies system

USE hotel_cms;

-- Add external hotel_id field to hotels table (if not exists)
ALTER TABLE hotels ADD COLUMN IF NOT EXISTS hotel_id VARCHAR(50) UNIQUE COMMENT 'External hotel ID (e.g. HB4I2, 57392, H5425)';
...
-- Insert sample policy item details
